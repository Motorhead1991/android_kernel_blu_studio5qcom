...
#wuchx added for 5971 dtb 20140423
 	...
 	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v2-qrd-skug-5971.dtb
#TYDRV jinxr added for 5987 dtb
else ifeq (y,$(findstring y,$(filter TYQ_TBT5987_SUPPORT=%,$(TY_CP_OPTION))))
 	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-qrd-skug-5987.dtb
 	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v2-qrd-skug-5987.dtb
#TYDRV niuli added for 5988 dtb
...
#TYDRV wang_gj added for 5706 dtb
else ifeq (y,$(findstring y,$(filter TYQ_TBW5706_SUPPORT=%,$(TY_CP_OPTION))))
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-qrd-skug-5706.dtb
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v2-qrd-skug-5706.dtb
#TYDRV lichm add for 5958e dtb
else ifeq (y,$(findstring y,$(filter TYQ_TBE5958E_SUPPORT=%,$(TY_CP_OPTION))))
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-qrd-skug-5958e.dtb
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v2-qrd-skug-5958e.dtb
#TYDRV xiangdong add for 5986 dtb
else ifeq (y,$(findstring y,$(filter TYQ_TBW5986_SUPPORT=%,$(TY_CP_OPTION))))
 	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-qrd-skug-5986.dtb
 	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v2-qrd-skug-5986.dtb
