...
#define OV5648_SENSOR_NAME "ov5648_rear"
DEFINE_MSM_MUTEX(ov5648_rear_mut);
...
static struct msm_sensor_ctrl_t ov5648_s_ctrl = {
	...
	.msm_sensor_mutex = &ov5648_rear_mut,
...
MODULE_DESCRIPTION("ov5648_rear");
