...
#define OV8858_SENSOR_NAME "ov8858_cm9554"
...
static const struct of_device_id ov8858_dt_match[] = {
	{.compatible = "ovti,ov8858_cm9554", .data = &ov8858_s_ctrl},
	{}
};
...
static int __init ov8858_cm9554_init_module(void)
{
	int32_t rc = 0;
	pr_info("%s:%d\n", __func__, __LINE__);
...
static void __exit ov8858_cm9554_exit_module(void)
{
	pr_info("%s:%d\n", __func__, __LINE__);
...
module_init(ov8858_cm9554_init_module);
module_exit(ov8858_cm9554_exit_module);
MODULE_DESCRIPTION("ov8858_cm9554");
